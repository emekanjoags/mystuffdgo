...
export default {
  ...
  methods: {
    handleFileUpload(){
      this.formData.team_a_logo = this.$refs.file.files[0]
    },
    createMatch: function() {
      ...
      axios
        .post("/trivia/api/create-match", {
          closed_at:this.formData.closed_at,
          event:this.formData.event,
          team_a:this.formData.team_a,
          team_b:this.formData.team_b,
          team_a_logo:this.formData.team_a_logo,
          team_b_logo:this.formData.team_b_logo,
