    ...
    def end_raffle_draw(self):
        ...
        if week_day == 6:
            if timezone.make_aware(
                ...
                #                                 :(topplay_limit+1)]
                # moderators = []
                # #THIS IS WHERE I THINK THE PROCESS STOPPED BECAUSE THEY WERE NO ACTIVE MOD USERS AND NO RAFFLE PLAYERS WERE CREATED, SO THE SLIPS WERE TICKED AS JACKPOT ==FALSE AND THE CONTENT OF THIS FUNCTION ONLY OCCURS ON SUNDAY
    ...
    def check_payments(self):
        ...
        if withdrawals.count():
            for withdrawal in withdrawals:
                withdrawal_check = Transfer(authorization_key='sk_test_a4770e6ffcf2715593c630c23bc899f1428f81eb').get_transfer(
                ...
                if withdrawal_check[1]:
                    if withdrawal_check[3]['status'] == 'success':
                        ...
                        print('updater was used to transact: ', wallet.balance)
                else:
