...
from .models import User, AutoImage
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('username', 'email', 'calling_code', 'phone', 'password', 'profile_image', 'referral_code', 'referred', 'birthday_msg_sent', 'birthday')}),
