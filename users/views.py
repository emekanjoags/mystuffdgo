...
class ProfileDetails(View):
    def get(self, request):
        ...
        birthday = str(profile_details.birthday)[5:]
    ...
    def post(self, request):
        ...
        if request.POST.get('birthday_day') and request.POST.get('birthday_mon'):
            birthday_day = request.POST.get('birthday_day')
            birthday_mon = request.POST.get('birthday_mon')
            birthday = '1000-{}-{}'.format(birthday_mon, birthday_day)
