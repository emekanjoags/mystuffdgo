...
from trivia.views import AdminTrivia, cancel_question, AdminTriviaResult, SetQuestionView
...
urlpatterns = [
    ...
    path('trivia/question', admin_auth_decorator(SetQuestionView.as_view()), name='trivia_question'),
