...
from .views import (EventsApiView, CreationDataAPi, CreateGameApi, GamesView, PlayTodayGames, TodayMatches,
                    UserGamesView, SlipGamesView, GameMatches, BetSlips, WinnersChart, EditMatches, RaffleWinnersView, RafflePlayers, StartFirstGame)
...
urlpatterns = [
    ...
    path('api/start-first-game',StartFirstGame.as_view()),
