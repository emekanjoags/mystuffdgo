...
photo = os.path.join(BASE_DIR, 'teams')
MEDIA_ROOT = os.path.join(BASE_DIR, 'assets') #THIS TELLS THE PROGRAM WHERE TO KEEP ALL YOUR UPLOADED MEDIA FILES AND WHERE TO GET THEM
MEDIA_URL = '/assets/' #this is the first path to a media file, it doesnt care about where the media files are kept
